              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      _buildIconButton(
                          Icons.arrow_back_ios, controller.previousWeek),
                      Obx(() => Text(
                      ...
                      _buildIconButton(
                          Icons.arrow_forward_ios, controller.nextWeek),
                    ],
                  ),
                  ...
                  Container(
                    ...
                    child: Obx(() => Row(
                          ...
                          children: [
                            _buildStat('${controller.dayTotalSeances}',
                                'Séances', const Color(0xFF536DFE)),
                            _buildStat('${controller.dayTotalStudents}',
                                'Elèves', Colors.green),
                            _buildStat(_dayTotalDuration(controller), 'Durée',
                                Colors.red),
                          ],
                        )),
                  ),
                    ...
                    ...controller.seances.asMap().entries.map((entry) {
                      ...
                      return _buildCourseCard(
                        ...
                        duration: _durationLabel(
                            s['heureDebut'] as String, s['heureFin'] as String),
                      );
                    }),
                ],
              ),
