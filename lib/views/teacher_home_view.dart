...
class TeacherHomeView extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          if (subtitle.isNotEmpty)
            ...
            const SizedBox(
                height:
                    11), // Pour garder le même alignement même sans sous-titre
        ],
      ),
    );
  }
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return _buildAgendaRow(
              hDebut, hFin, matiere, classe, color, statut, controller, index);
        },
      ),
    );
  }
  ...
  Widget _buildAgendaRow(String t1, String t2, String subject, String sub,
      Color color, String statut, TeacherHomeController controller, int index) {
    final s = controller.seances[index];
